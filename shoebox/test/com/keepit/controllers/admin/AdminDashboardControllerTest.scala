    ...
    "get users by date as JSON" in {
      running(new EmptyApplication()) {
        ...
        val u1 = CX.withConnection { implicit c =>
          val u1 = User(createdAt = currentDateTime.minusDays(3), firstName = "A", lastName = "1").save
          val u2 = User(createdAt = currentDateTime.minusDays(1), firstName = "B", lastName = "2").save
          val u3 = User(createdAt = currentDateTime.minusDays(1), firstName = "C", lastName = "3").save
        ...
        contentAsString(result) === "{\"day0\":\"2012-11-13\",\"userCounts\":[1,0,2,0]}"
      }
    }
  }

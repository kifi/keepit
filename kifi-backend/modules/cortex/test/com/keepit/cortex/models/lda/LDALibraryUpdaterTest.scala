    ...
    "work" in {
      withDb() { implicit injector =>
        ...
        db.readWrite { implicit s =>
          keepRepo.save(CortexKeep(keptAt = time, userId = Some(Id[User](1)), keepId = Id[Keep](1), uriId = Id[NormalizedURI](1L), isPrivate = false, state = State[CortexKeep]("active"), seq = SequenceNumber[CortexKeep](1L), source = KeepSource.keeper, libraryId = Some(Id[Library](1))))
          keepRepo.save(CortexKeep(keptAt = time, userId = Some(Id[User](1)), keepId = Id[Keep](2), uriId = Id[NormalizedURI](2L), isPrivate = false, state = State[CortexKeep]("active"), seq = SequenceNumber[CortexKeep](2L), source = KeepSource.keeper, libraryId = Some(Id[Library](1))))
          keepRepo.save(CortexKeep(keptAt = time, userId = Some(Id[User](1)), keepId = Id[Keep](3), uriId = Id[NormalizedURI](3L), isPrivate = false, state = State[CortexKeep]("active"), seq = SequenceNumber[CortexKeep](3L), source = KeepSource.keeper, libraryId = Some(Id[Library](2))))

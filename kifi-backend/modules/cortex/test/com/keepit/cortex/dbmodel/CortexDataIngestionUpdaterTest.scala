    ...
    "be able to get data from shoebox client" in {
      withDb(){ implicit injector =>
        ...
        shoebox.saveBookmarks(
          Keep(uriId = Id[NormalizedURI](1), url = "url1", urlId = Id[URL](1), source = KeepSource.keeper, userId = Id[User](1)),
          Keep(uriId = Id[NormalizedURI](2), url = "url1", urlId = Id[URL](2), source = KeepSource.bookmarkImport, userId = Id[User](2))
        )

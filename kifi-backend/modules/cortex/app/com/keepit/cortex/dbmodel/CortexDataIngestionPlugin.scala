...
private class CortexDataIngestionPluginImpl @Inject() (
  ...
  override def onStart() {
    scheduleTaskOnOneMachine(actor.system, 1 minute, 1 minute, actor.ref, UpdateURI, UpdateURI.getClass.getSimpleName)
    scheduleTaskOnOneMachine(actor.system, 1 minute, 1 minute, actor.ref, UpdateKeep, UpdateKeep.getClass.getSimpleName)
    scheduleTaskOnOneMachine(actor.system, 1 minute, 1 minute, actor.ref, UpdateLibrary, UpdateLibrary.getClass.getSimpleName)
    scheduleTaskOnOneMachine(actor.system, 1 minute, 1 minute, actor.ref, UpdateLibraryMembership, UpdateLibraryMembership.getClass.getSimpleName)
  }

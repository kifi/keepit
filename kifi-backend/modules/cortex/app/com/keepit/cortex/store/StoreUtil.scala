  ...
  object DenseWordVecFormatter {
    ...
    def fromBinary(bytes: Array[Byte]): (Int, Map[String, Array[Float]]) = {
      ...
      while (n < vocSize){
        ...
        ch = is.readChar()
        while (ch != SEP){ sb.append(ch); ch = is.readChar() }

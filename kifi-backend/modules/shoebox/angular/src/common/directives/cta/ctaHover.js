  ...
  .directive('kfCtaHover', [
    ...
    function ($rootScope, $timeout, $window) {
      return {
        ...
        templateUrl: 'common/directives/cta/ctaHover.tpl.html',
        link: function (scope, element) {
          ...
          function show(opts) {
            ...
            if (delegate && delegate.onHover) {
              delegate.onHover(opts.auto);
            }
          ...
          scope.title = scope.delegate.title;
          ...
          var button = element.next('.kf-cta-hover-element');

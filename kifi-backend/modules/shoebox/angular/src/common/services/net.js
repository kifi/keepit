...
.factory('net', [
  ...
  function (env, $http, createExpiringCache) {
    ...
    return {
      ...
      getBasicLibraries: get(shoebox, '/users/:id/basicLibraries?offset=:offset&limit=:limit'), // [ordering&direction]
      ...
      getOrgBasicLibraries: get(shoebox, '/organizations/:id/basicLibraries?offset=:offset&limit=:limit'), // [ordering&direction]
      ...
      getInitialLeftHandRailInfo: get(shoebox, '/user/leftHandRail?numLibs=:numLibs'), // &[ordering=alphabetical&direction=asc]

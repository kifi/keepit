...
.factory('net', [
  ...
  function (env, $http, createExpiringCache) {
    ...
    return {
      ...
      getBasicLibraries: get(shoebox, '/users/:id/basicLibraries?offset=:offset&limit=:limit&ordering=most_recent_keeps_by_user&direction=desc&window_size=14'), // [ordering&direction]
      ...
      getOrgBasicLibraries: get(shoebox, '/organizations/:id/basicLibraries?offset=:offset&limit=:limit&ordering=most_recent_keeps_by_user&direction=desc&window_size=14'), // [ordering&direction]
      ...
      getInitialLeftHandRailInfo: get(shoebox, '/user/leftHandRail?numLibs=:numLibs&ordering=most_recent_keeps_by_user&direction=desc&windowSize=14'),

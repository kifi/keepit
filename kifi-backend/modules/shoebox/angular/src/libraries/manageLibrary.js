...
.directive('kfManageLibrary', ['$location', 'libraryService', 'profileService',
  function ($location, libraryService, profileService) {
    return {
      restrict: 'A',
      scope: {},
      require: '^kfModal',
      ...
      link: function (scope, element, attrs, kfModalCtrl) {
        ...
        scope.$watch(function () {
          ...
          scope.userHasEditedSlug = scope.library.name && (newVal !== oldVal) ? true : false;

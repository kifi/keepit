...
.directive('kfLibraryFollowers', [
  '$location', '$window', '$rootScope', 'friendService', 'libraryService', 'routeService', 'userService',
  function ($location, $window, $rootScope, friendService, libraryService, routeService, userService) {
    return {
      restrict: 'A',
      require: '^kfModal',

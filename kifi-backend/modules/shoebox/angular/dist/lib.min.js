...
angular.module("jun.smartScroll",[]).directive("smartScroll",["$rootScope","$window","$timeout",function(a,b,c){"use strict";function d(a){if(a.style){var b=m(a);return e(b.css("overflow"))||e(b.css("overflow-y"))}return!1}function e(a){return"scroll"===a||"auto"===a}function f(a,b){for(;a;){if(b(a))return a;a=a.parentNode}return null}function g(a,b){return a?"string"==typeof a?h(a,"%")?parseInt(a,10)/100*b:parseInt(a,10):a:0}function h(a,b){return a===b||-1!==a.indexOf(b,a.length-b.length)}function i(a){return a===b&&(a=l||(l=m("html")[0])),a.scrollHeight}function j(a,b){return function(){if(!a.disabled){var c=i(b[0]),d=b.scrollTop(),e=b.innerHeight(),f=d+e,h=c-f,j=.9,k=g(a.distance,e)+j;k>=h&&a.next({scrollHeight:c,scrollTop:d,height:e,scrollBottom:f,remaining:h})}}}function k(a,c){var d=b._;if(!d||"function"!=typeof d.throttle)return c;var e=a.throttle,f=300;switch(typeof e){case"number":f=e;break;case"object":if(e)return null!=e.wait&&(f=e.wait),d.throttle(c,f,e)}return d.throttle(c,f)}var l,m=angular.element;return{scope:{distance:"=scrollDistance",disabled:"=scrollDisabled",throttle:"=scrollThrottle",next:"&scrollNext"},link:function(a,e){var g=f(e[0],d)||b;g=angular.element(g);var h=j(a,g),i=k(a,h);a.$watch("distance",h),a.$watch("disabled",h),g.scroll(i),a.$on("$destroy",function(){g.off("scroll",i)}),c(h)}}}]);
//! moment.js
//! version : 2.5.1

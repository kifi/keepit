...
trait PlanManagementCommander {
  ...
  def createNewPlan(name: Name[PaidPlan], billingCycle: BillingCycle, price: DollarAmount, custom: Boolean = false, editableFeatures: Set[Feature[_]], defaultSettings: OrganizationSettings): PaidPlan
...
class PlanManagementCommanderImpl @Inject() (
  ...
  def createNewPlanHelper(name: Name[PaidPlan], billingCycle: BillingCycle, price: DollarAmount, custom: Boolean = false, editableFeatures: Set[Feature[_]], defaultSettings: OrganizationSettings)(implicit session: RWSession): PaidPlan = {

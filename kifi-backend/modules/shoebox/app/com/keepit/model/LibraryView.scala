...
object LibraryInfo {
  ...
  def fromLibraryAndOwner(lib: Library, image: Option[LibraryImage], owner: BasicUser, org: Option[PrimaryOrganizationHandle], inviter: Option[BasicUser] = None)(implicit config: PublicIdConfiguration): LibraryInfo = {
    LibraryInfo(

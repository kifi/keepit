...
trait LibraryRepo extends Repo[Library] with SeqNumberFunction[Library] {
  ...
  def getOwnerLibrariesForAnonymous(ownerId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection], starredFirst: Boolean)(implicit session: RSession): Seq[Library]
  def getOwnerLibrariesForOtherUser(userId: Id[User], friendId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection], starredFirst: Boolean)(implicit session: RSession): Seq[Library]
  ...
  def getFollowingLibrariesForAnonymous(userId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection], starredFirst: Boolean)(implicit session: RSession): Seq[Library]
  def getFollowingLibrariesForOtherUser(userId: Id[User], friendId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection], starredFirst: Boolean)(implicit session: RSession): Seq[Library]
  def getFollowingLibrariesForSelf(userId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection], starredFirst: Boolean)(implicit session: RSession): Seq[Library]
...
class LibraryRepoImpl @Inject() (
  ...
  def getOwnerLibrariesForAnonymous(userId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection], starredFirst: Boolean)(implicit session: RSession): Seq[Library] = {
    import com.keepit.common.db.slick.StaticQueryFixed.interpolation
    val query =
      sql"""select lib.* from library_membership lm, library lib
           ...
           order by #${getOrderBySql("lib", "lm", ordering, direction, starredFirst)} limit ${page.itemsToDrop}, ${page.size}"""
  ...
  def getOrderBySql(tableName: String, membershipTable: String, orderingOpt: Option[LibraryOrdering], direction: Option[SortDirection], starredFirst: Boolean) = {

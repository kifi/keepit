...
trait LibraryRepo extends Repo[Library] with SeqNumberFunction[Library] {
  ...
  def getOwnerLibrariesForAnonymous(ownerId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection])(implicit session: RSession): Seq[Library]
  def getOwnerLibrariesForOtherUser(userId: Id[User], friendId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection])(implicit session: RSession): Seq[Library]
  def getOwnerLibrariesForSelf(userId: Id[User], page: Paginator)(implicit session: RSession): Seq[Library]
  def getOwnerLibrariesForSelfWithOrdering(userId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection])(implicit session: RSession): Seq[Library]
  def getInvitedLibrariesForSelf(userId: Id[User], page: Paginator)(implicit session: RSession): Seq[(Library, LibraryInvite)]

  def getFollowingLibrariesForAnonymous(userId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection])(implicit session: RSession): Seq[Library]
  def getFollowingLibrariesForOtherUser(userId: Id[User], friendId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection])(implicit session: RSession): Seq[Library]
  def getFollowingLibrariesForSelf(userId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection])(implicit session: RSession): Seq[Library]
...
class LibraryRepoImpl @Inject() (
  ...
  def getOwnerLibrariesForAnonymous(userId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection])(implicit session: RSession): Seq[Library] = {
    import com.keepit.common.db.slick.StaticQueryFixed.interpolation
    val query =
      sql"""select lib.* from library_membership lm, library lib
           ...
           order by #${getOrderBySql("lib", "lm", ordering, direction)} limit ${page.itemsToDrop}, ${page.size}"""
  ...
  def getOwnerLibrariesForSelfWithOrdering(userId: Id[User], page: Paginator, ordering: Option[LibraryOrdering], direction: Option[SortDirection])(implicit session: RSession): Seq[Library] = {
    ...
    val query = sql"""select lib.* from library lib
                  ...
                  #${getOrderBySql("lib", "lm", ordering, direction)} limit ${page.itemsToDrop}, ${page.size}"""
    query.as[Library].list
  }

  def getOrderBySql(tableName: String, membershipTable: String, orderingOpt: Option[LibraryOrdering], direction: Option[SortDirection], starredFirst: Boolean = false) = {

        ...
        def saveKeep(k: Keep, s: RWSession): Either[LibraryError, Keep] = {
          ...
          currentKeepOpt match {
            case None =>
              ...
              keepToLibraryCommander.addKeepToLibrary(KeepToLibraryAddRequest(keepId = newKeep.id.get, libraryId = toLibraryId, requesterId = userId))
        ...
        def saveKeep(k: Keep, s: RWSession): Either[LibraryError, Keep] = {
          ...
          existingKeepOpt match {
            case None =>
              ...
              keepToLibraryCommander.addKeepToLibrary(KeepToLibraryAddRequest(keepId = movedKeep.id.get, libraryId = toLibraryId, requesterId = userId))
              Right(movedKeep)

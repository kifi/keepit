...
trait EmailSenderProvider {
  ...
  def twitterWaitlistOldUsers: TwitterWaitlistOldUsersEmailSender
}
...
class EmailSenderProviderImpl @Inject() (
    ...
    private val twitterWaitlistOldUsersEmailSender: Provider[TwitterWaitlistOldUsersEmailSender]) extends EmailSenderProvider {
  ...
  lazy val twitterWaitlistOldUsers = twitterWaitlistOldUsersEmailSender.get()
}

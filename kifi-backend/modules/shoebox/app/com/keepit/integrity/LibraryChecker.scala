...
class LibraryChecker @Inject() (val airbrake: AirbrakeNotifier,
    ...
    val libraryFetchCommander: LibraryFetchCommander,
  ...
  private[integrity] def checkSystemLibraries(): Unit = {
    ...
    db.readOnlyReplica { implicit s =>
      ...
      // libraryFetchCommander.internSystemGeneratedLibraries does the following...
      ...
      libraryFetchCommander.internSystemGeneratedLibraries(u.id.get, false)
    }
    timer.stopAndReport(appLog = true)
  }

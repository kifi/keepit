...
case class ShoeboxProdModule() extends ShoeboxModule (
  ...
  val discoveryModule = new ProdDiscoveryModule {
    def servicesToListenOn: Seq[ServiceType] = ServiceType.SEARCH :: ServiceType.SHOEBOX :: ServiceType.ELIZA :: ServiceType.HEIMDAL :: ServiceType.ABOOK :: ServiceType.SCRAPER :: ServiceType.C_SHOEBOX :: Nil
  }
}

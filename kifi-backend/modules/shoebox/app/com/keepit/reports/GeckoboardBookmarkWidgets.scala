...
class TotalKeepsPerHour @Inject() (val db: Database, val clock: Clock)
...
class UIKeepsPerHour @Inject() (val db: Database, val clock: Clock)
...
class KeepersPerHour @Inject() (val db: Database, val clock: Clock)
...
class TotalKeepsPerDay @Inject() (val db: Database, val clock: Clock)
...
class UIKeepsPerDay @Inject() (val db: Database, val clock: Clock)
...
class KeepersPerDay @Inject() (val db: Database, val clock: Clock)
...
class TotalKeepsPerWeek @Inject() (val db: Database, val clock: Clock)
...
class UIKeepsPerWeek @Inject() (val db: Database, val clock: Clock)
...
class KeepersPerWeek @Inject() (val db: Database, val clock: Clock)
...
class TotalKeepsPerMonth @Inject() (val db: Database, val clock: Clock)
...
class UIKeepsPerMonth @Inject() (val db: Database, val clock: Clock)
...
class KeepersPerMonth @Inject() (val db: Database, val clock: Clock)

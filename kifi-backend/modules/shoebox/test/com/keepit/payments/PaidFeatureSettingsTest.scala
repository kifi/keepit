  ...
  "publish library permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.PublishLibraries -> FeatureSelection.ADMINS) }
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.PublishLibraries -> FeatureSelection.MEMBERS) }
  ...
  "invite member permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.InviteMembers -> FeatureSelection.ADMINS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, initOrgSettings)) must beRight
        ...
        // admins can alter feature settings
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.InviteMembers -> FeatureSelection.MEMBERS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, orgSettings)) must beRight
  ...
  "force-edit library permissions" should {
    "be configurable" in {
      ...
      withDb(modules: _*) { implicit injector =>
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.ForceEditLibraries -> FeatureSelection.ADMINS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, orgSettings)) must beRight
  ...
  "view members permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.ViewMembers -> FeatureSelection.MEMBERS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, initOrgSettings)) must beRight
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.ViewMembers -> FeatureSelection.ANYONE) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, orgSettings)) must beRight
  ...
  "edit organization permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.EditOrganization -> FeatureSelection.ADMINS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, initOrgSettings)) must beRight
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.EditOrganization -> FeatureSelection.MEMBERS) }
  ...
  "move org libraries permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.RemoveLibraries -> FeatureSelection.ADMINS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, initOrgSettings)) must beRight
        ...
        val orgSettings2 = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.RemoveLibraries -> FeatureSelection.MEMBERS) }
  ...
  "export keeps permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.ExportKeeps -> FeatureSelection.ADMINS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, initOrgSettings)) must beRight
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.ExportKeeps -> FeatureSelection.MEMBERS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, orgSettings)) must beRight
  ...
  "group messaging permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.GroupMessaging -> FeatureSelection.DISABLED) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, initOrgSettings)) must beRight
        ...
        val orgSettings1 = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.GroupMessaging -> FeatureSelection.ADMINS) }
        ...
        val orgSettings2 = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.GroupMessaging -> FeatureSelection.MEMBERS) }
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, admin.id.get, orgSettings2)) must beRight
  ...
  "verify to join permission" should {
    "auto-join org upon shared email verification" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.JoinByVerifying -> FeatureSelection.DISABLED) }
        ...
        val newOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.JoinByVerifying -> FeatureSelection.NONMEMBERS) }
  ...
  "slack settings" should {
    "be configurable with CREATE_SLACK_INTEGRATION permission" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings.withFeatureSetTo(Feature.CreateSlackIntegration -> FeatureSelection.DISABLED) }
        val alteredSlackSettings = OrganizationSettings(Map(Feature.SlackIngestionReaction -> FeatureSelection.ENABLED, Feature.SlackNotifications -> FeatureSelection.DISABLED))
        ...
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, owner.id.get, OrganizationSettings(Map(Feature.CreateSlackIntegration -> FeatureSelection.ADMINS)))) must beRight
        ...
        orgCommander.setAccountFeatureSettings(OrganizationSettingsRequest(org.id.get, owner.id.get, OrganizationSettings(Map(Feature.CreateSlackIntegration -> FeatureSelection.MEMBERS)))) must beRight

  ...
  "publish library permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.PublishLibraries -> Feature.PublishLibraries.ADMINS)).get
        ...
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.PublishLibraries -> Feature.PublishLibraries.MEMBERS))
  ...
  "invite member permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.InviteMembers -> Feature.InviteMembers.ADMINS))
        ...
        // admins can alter feature settings
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.InviteMembers -> Feature.InviteMembers.MEMBERS))
  ...
  "force-edit library permissions" should {
    "be configurable" in {
      ...
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.ForceEditLibraries -> Feature.ForceEditLibraries.ADMINS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.ForceEditLibraries -> Feature.ForceEditLibraries.MEMBERS)).get
  ...
  "view members permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.ViewMembers -> Feature.ViewMembers.MEMBERS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.ViewMembers -> Feature.ViewMembers.ANYONE)).get
  ...
  "edit organization permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.EditOrganization -> Feature.EditOrganization.ADMINS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, owner.id.get, orgSettings.set(Feature.EditOrganization -> Feature.EditOrganization.MEMBERS))
  ...
  "move org libraries permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.RemoveLibraries -> Feature.RemoveLibraries.DISABLED)).get
        ...
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings1.set(Feature.RemoveLibraries -> Feature.RemoveLibraries.ADMINS))
        ...
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings2.set(Feature.RemoveLibraries -> Feature.RemoveLibraries.MEMBERS))
  ...
  "create slack integration permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.CreateSlackIntegration -> Feature.CreateSlackIntegration.ADMINS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.CreateSlackIntegration -> Feature.CreateSlackIntegration.MEMBERS))
  ...
  "export keeps permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        // Initially, only admins
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.ExportKeeps -> Feature.ExportKeeps.ADMINS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.ExportKeeps -> Feature.ExportKeeps.MEMBERS))
  ...
  "group messaging permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.MessageOrganization -> Feature.MessageOrganization.DISABLED)).get
        ...
        val orgSettings1 = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings1.set(Feature.MessageOrganization -> Feature.MessageOrganization.ADMINS))
        ...
        val orgSettings2 = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings2.set(Feature.MessageOrganization -> Feature.MessageOrganization.MEMBERS))

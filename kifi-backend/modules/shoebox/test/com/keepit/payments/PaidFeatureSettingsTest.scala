  ...
  "publish library permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.PublishLibraries -> FeatureSetting.ADMINS)).get
        ...
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.PublishLibraries -> FeatureSetting.MEMBERS))
  ...
  "invite member permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.InviteMembers -> FeatureSetting.ADMINS))
        ...
        // admins can alter feature settings
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.InviteMembers -> FeatureSetting.MEMBERS))
  ...
  "force-edit library permissions" should {
    "be configurable" in {
      ...
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.ForceEditLibraries -> FeatureSetting.ADMINS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.ForceEditLibraries -> FeatureSetting.MEMBERS)).get
  ...
  "view members permissions" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.ViewMembers -> FeatureSetting.MEMBERS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.ViewMembers -> FeatureSetting.ANYONE)).get
  ...
  "edit organization permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.EditOrganization -> FeatureSetting.ADMINS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, owner.id.get, orgSettings.set(Feature.EditOrganization -> FeatureSetting.MEMBERS))
  ...
  "move org libraries permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.RemoveLibraries -> FeatureSetting.DISABLED)).get
        ...
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings1.set(Feature.RemoveLibraries -> FeatureSetting.ADMINS))
        ...
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings2.set(Feature.RemoveLibraries -> FeatureSetting.MEMBERS))
  ...
  "create slack integration permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.CreateSlackIntegration -> FeatureSetting.ADMINS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.CreateSlackIntegration -> FeatureSetting.MEMBERS))
  ...
  "export keeps permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        // Initially, only admins
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.ExportKeeps -> FeatureSetting.ADMINS)).get
        ...
        val orgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings.set(Feature.ExportKeeps -> FeatureSetting.MEMBERS))
  ...
  "group messaging permission" should {
    "be configurable" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val initOrgSettings = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, initOrgSettings.set(Feature.MessageOrganization -> FeatureSetting.DISABLED)).get
        ...
        val orgSettings1 = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings1.set(Feature.MessageOrganization -> FeatureSetting.ADMINS))
        ...
        val orgSettings2 = db.readOnlyMaster { implicit session => orgConfigRepo.getByOrgId(org.id.get).settings }
        planManagementCommander.setAccountFeatureSettings(org.id.get, admin.id.get, orgSettings2.set(Feature.MessageOrganization -> FeatureSetting.MEMBERS))

    ...
    "return connected users from the database" in {
      withDb(mobileControllerTestModules: _*) { implicit injector =>
        ...
        val (user1, uri) = db.readWrite { implicit s =>
          val user1 = userRepo.save(User(firstName = "Shanee", lastName = "Smith", externalId = ExternalId("aaaaaaaa-51ad-4c7d-a88e-d4e6e3c9a672"), username = Username("test1"), normalizedUsername = "test1", pictureName = Some("0")))
          val user2 = userRepo.save(User(firstName = "Shachaf", lastName = "Smith", externalId = ExternalId("bbbbbbbb-51ad-4c7d-a88e-d4e6e3c9a673"), username = Username("test"), normalizedUsername = "test", pictureName = Some("0")))
    ...
    "query extension " in {
      withDb(mobileControllerTestModules: _*) { implicit injector =>
        ...
        val (user1, uri) = db.readWrite { implicit s =>
          ...
          val user1935 = userRepo.save(User(firstName = "James", lastName = "Chadwick", externalId = ExternalId("e58be33f-51ad-4c7d-a88e-d4e6e3c9a674"), username = Username("test1"), normalizedUsername = "test1", pictureName = Some("0")))

      ...
      withDb(modules: _*) { implicit injector =>
        ...
        val recoInfos = Seq(FullRecoInfo(
          ...
          itemInfo = UriRecoItemInfo(id = ExternalId[NormalizedURI]("0cb299dd-5b9e-47b1-8377-3692051dd972"),
            ...
            keepers = Seq(BasicUser(externalId = ExternalId[User]("aa25f5a8-8dea-4e56-82c1-a4dcf38f205c"),
              ...
              lastName = "Smith",
              pictureName = "asdf",
              username = Username("joe"), active = true)),
            libraries = Seq.empty,
            others = 12,
            siteName = Some("fafa"),
        ...
        val expected =
          """[{"kind":"keep",
             ...
             "title":"bar",
             "url":"http://bar.com",
             "keepers":[{"id":"aa25f5a8-8dea-4e56-82c1-a4dcf38f205c","firstName":"Joe","lastName":"Smith","pictureName":"asdf","username":"joe", "active":true}],
             "libraries": [],
             "others":12,
             "siteName":"fafa",
             "summary":{"title":"Yo!"}},

...
class AdminAuthControllerTest extends Specification with ApplicationInjector with ShoeboxInjectionHelpers {
  ...
  "AdminAuthController" should {
    "impersonate" in {
      running(new DeprecatedEmptyApplication().withFakeSecureSocialUserService()) {

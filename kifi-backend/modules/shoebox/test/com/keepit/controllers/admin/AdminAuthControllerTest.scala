    ...
    "impersonate" in {
      running(new ShoeboxApplication(modules: _*)) {
        ...
        val (admin, impersonate) = db.readWrite { implicit s =>
          val admin = userRepo.save(User(firstName = "A", lastName = "1", username = Username("test"), normalizedUsername = "test", pictureName = Some("0")))
          ...
          val impersonate = userRepo.save(User(firstName = "B", lastName = "1", username = Username("test2"), normalizedUsername = "test2", pictureName = Some("0")))

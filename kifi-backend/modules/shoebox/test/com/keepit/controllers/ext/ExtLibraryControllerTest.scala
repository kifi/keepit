...
class ExtLibraryControllerTest extends Specification with ShoeboxTestInjector with DbInjectionHelper {
  ...
  "ExtLibraryController" should {
    "get libraries" in {
      withDb(controllerTestModules: _*) { implicit injector =>
        val (user1, user2, lib1, lib2, lib3) = db.readWrite { implicit s =>
          val user1 = userRepo.save(User(firstName = "Morgan", lastName = "Freeman", username = Username("morgan"), normalizedUsername = "test", pictureName = Some("0")))
          ...
          val user2 = userRepo.save(User(firstName = "Michael", lastName = "Caine", username = Username("michael"), normalizedUsername = "test", pictureName = Some("0")))
    ...
    "create library" in {
      withDb(controllerTestModules: _*) { implicit injector =>
        val user1 = db.readWrite { implicit s =>
          userRepo.save(User(firstName = "U", lastName = "1", username = Username("test"), normalizedUsername = "test", pictureName = Some("0")))
        }
        implicit val config = inject[PublicIdConfiguration]
    ...
    "get library" in {
      withDb(controllerTestModules: _*) { implicit injector =>
        val (user1, user2, lib1, lib2, mem1, mem2) = db.readWrite { implicit s =>
          val user1 = userRepo.save(User(firstName = "U", lastName = "1", username = Username("test"), normalizedUsername = "test", pictureName = Some("0")))
          val user2 = userRepo.save(User(firstName = "U", lastName = "2", username = Username("test"), normalizedUsername = "test", pictureName = Some("0")))
    ...
    "add keep to library" in {
      withDb(controllerTestModules: _*) { implicit injector =>
        val (user1, user2, lib1, lib2, lib3) = db.readWrite { implicit s =>
          val user1 = userRepo.save(User(firstName = "Kanye", lastName = "West", username = Username("kanye"), normalizedUsername = "test", pictureName = Some("0")))
          ...
          val user2 = userRepo.save(User(firstName = "Taylor", lastName = "Swift", username = Username("taylor"), normalizedUsername = "test", pictureName = Some("0")))
    ...
    "remove keep from library" in {
      withDb(controllerTestModules: _*) { implicit injector =>
        ...
        val (user1, user2, lib1, lib2, keep1, keep2, keep3) = db.readWrite { implicit s =>
          ...
          val user1 = userRepo.save(User(firstName = "Colin", lastName = "Kaepernick", username = Username("qb"), createdAt = t1, normalizedUsername = "test", pictureName = Some("0")))
          ...
          val user2 = userRepo.save(User(firstName = "Jim", lastName = "Harbaugh", username = Username("coach"), createdAt = t1, normalizedUsername = "test2", pictureName = Some("0")))

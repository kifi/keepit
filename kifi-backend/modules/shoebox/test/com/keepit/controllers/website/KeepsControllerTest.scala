           ...
           "keeps":[
            {
              ...
              "keepers":[{"id":"${user2.externalId.toString}","firstName":"Eishay","lastName":"S","pictureName":"0.jpg", "username":"test", "active":true}],
              "keepersOmitted": 0,
              "keepersTotal": 3,
              "libraries":[],
              "librariesOmitted": 0,
                   ...
                   "keeps":[
                    {
                      ...
                      "keepers":[{"id":"${u2.externalId.toString}","firstName":"${u2.firstName}","lastName":"${u2.lastName}","pictureName":"0.jpg","username":"test", "active":true}],
                      "keepersOmitted": 0,
                      "keepersTotal": 3,
                      "libraries":[],
                      "librariesOmitted": 0,

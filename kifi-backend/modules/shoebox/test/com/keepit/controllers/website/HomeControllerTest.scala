    ...
    "iPhoneAppStoreRedirectWithTracking" should {
      "render HTML that redirects the user to the iOS app" in {
        withDb(modules: _*) { implicit injector =>
          ...
          val result = call(FakeRequest("GET", "https://www.kifi.com/invite?friend=03dfb0f0-24cb-11e4-8c21-0800200c9a66"))

          val body = contentAsString(result)
          body must contain("kifi://www.kifi.com/invite?friend=03dfb0f0-24cb-11e4-8c21-0800200c9a66")
        }
      }
    }
  }

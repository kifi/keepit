...
class PrenormalizerTest extends Specification with ShoeboxTestInjector {
  ...
  "Prenormalizer" should {
    ...
    "normalize query" in {
      ...
      prenormalize("http://keepitfindit.com/p?a=1=1") === "http://keepitfindit.com/p?a=1%3D1"
      val escapedEqual = java.net.URLEncoder.encode("=", "UTF-8")
      prenormalize("http://keepitfindit.com/p?a=1"+escapedEqual+"1") === "http://keepitfindit.com/p?a=1%3D1"
      ...
      prenormalize("http://www.example.com/display?category=foo/bar+baz") === "http://www.example.com/display?category=foo%2Fbar+baz"
      prenormalize("http://www.example.com/display?category=foo%2Fbar%20baz") === "http://www.example.com/display?category=foo%2Fbar+baz"
    ...
    "use custom normalizer when applicable" in {
      ...
      // techcrunch
      prenormalize("http://www.techcrunch.com") === "http://techcrunch.com"
      prenormalize("http://techcrunch.com") === "http://techcrunch.com"

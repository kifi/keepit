  ...
  "BookmarkInterner" should {
    ...
    "persist keep" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val (main, secret) = inject[LibraryInfoCommander].internSystemGeneratedLibraries(user.id.get)
    ...
    "persist bookmarks" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val (library, _) = inject[LibraryInfoCommander].internSystemGeneratedLibraries(user.id.get)
        val bookmarkInterner = inject[KeepInterner]

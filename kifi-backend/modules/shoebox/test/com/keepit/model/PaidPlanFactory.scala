...
object PaidPlanFactory {
  ...
  val testPlanEditableFeatures = Set.empty[Feature[_]]
  val testPlanSettings: OrganizationSettings = OrganizationSettings(Set(
    FeatureSettingPair(Feature.PublishLibraries, FeatureSetting.MEMBERS),
    FeatureSettingPair(Feature.InviteMembers, FeatureSetting.MEMBERS),
    FeatureSettingPair(Feature.MessageOrganization, FeatureSetting.MEMBERS),
    FeatureSettingPair(Feature.ForceEditLibraries, FeatureSetting.DISABLED),
    FeatureSettingPair(Feature.ViewOrganization, FeatureSetting.ANYONE),
    FeatureSettingPair(Feature.ViewMembers, FeatureSetting.ANYONE),
    FeatureSettingPair(Feature.RemoveLibraries, FeatureSetting.MEMBERS),
    FeatureSettingPair(Feature.CreateSlackIntegration, FeatureSetting.DISABLED),
    FeatureSettingPair(Feature.EditOrganization, FeatureSetting.ADMINS),
    FeatureSettingPair(Feature.ExportKeeps, FeatureSetting.ADMINS)
  ))

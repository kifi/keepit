...
class CollectionTest extends Specification with CommonTestInjector with DbInjectionHelper with ShoeboxInjectionHelpers {
  ...
  def setup()(implicit injector: Injector) = {
    ...
    db.readWrite { implicit s =>
      val user1 = userRepo.save(User(firstName = "Andrew", lastName = "Conner", createdAt = t1, username = Username("test"), normalizedUsername = "test", pictureName = Some("0")))
      val user2 = userRepo.save(User(firstName = "Eishay", lastName = "Smith", createdAt = t2, username = Username("test2"), normalizedUsername = "test2", pictureName = Some("0")))

    ...
    "save and load" in {
      withDb() { implicit injector =>
        ...
        val (u1, u2, d1, d2, u1d1, u1d2, u2d2) = inject[Database].readWrite { implicit session =>
          ...
          val d1 = inject[DomainRepo].save(Domain(hostname = "outlook.com", hash = DomainHash.hashHostname("outlook.com")))
          val d2 = inject[DomainRepo].save(Domain(hostname = "audible.com", hash = DomainHash.hashHostname("audible.com")))
          (u1, u2, d1, d2,

...
class MetricManager @Inject() (
  ...
  val definedRestrictions = Map[String, ContextRestriction](
    ...
    "kifiresultclicked" -> ConditionalContextRestriction(AnyContextRestriction("context.resultSource", EqualTo(ContextStringData("Kifi"))), EventType("clicked_search_result")),

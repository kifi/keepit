...
class LibraryIndexer(indexDirectory: IndexDirectory, shoebox: ShoeboxServiceClient, val airbrake: AirbrakeNotifier) extends Indexer[Library, Library, LibraryIndexable, LibraryIndexer](indexDirectory, LibraryFields.maxPrefixLength) {

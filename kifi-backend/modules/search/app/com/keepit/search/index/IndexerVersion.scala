...
object IndexerVersionProviders {
  ...
  case object Library extends IndexerVersionProvider(4, 4)
  case object Keep extends IndexerVersionProvider(1, 1)
}

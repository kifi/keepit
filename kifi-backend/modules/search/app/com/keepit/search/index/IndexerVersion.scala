...
object IndexerVersionProviders {
  ...
  case object Library extends IndexerVersionProvider(3, 4)
  case object Keep extends IndexerVersionProvider(0, 1)
}

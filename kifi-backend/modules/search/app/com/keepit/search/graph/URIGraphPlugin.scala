...
) extends ShardedIndexerPluginImpl[NormalizedURI, Keep, URIGraphIndexer, URIGraphActor](indexer, actor, serviceDiscovery) with URIGraphPlugin

class URIGraphActor @Inject()(
  airbrake: AirbrakeNotifier,
  indexer: ShardedURIGraphIndexer
) extends IndexerActor[Keep, URIGraphIndexer](airbrake, indexer)

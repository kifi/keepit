  ...
  "QueryExpansion" should {
    "expand queries (with no concat)" in new QueryParserScope(concatBoostValue = 0.0f) {
      parser.parse("super conductivity").get.toString ===
        s"TextQuery((title:super | title_stemmed:super)~$p (t:super | c:super | site_keywords:super | ts:super | cs:super)~$r ()) "+
        s"TextQuery((title:conductivity | title_stemmed:conductivity)~$p (t:conductivity | c:conductivity | site_keywords:conductivity | ts:conductivity | cs:conductivity)~$r ())"

      parser.parse("Electromagnetically induced transparency").get.toString ===
        s"TextQuery((title:electromagnetically | title_stemmed:electromagnet)~$p (t:electromagnetically | c:electromagnetically | site_keywords:electromagnetically | ts:electromagnet | cs:electromagnet)~$r ()) "+
        s"TextQuery((title:induced | title_stemmed:induce)~$p (t:induced | c:induced | site_keywords:induced | ts:induce | cs:induce)~$r ()) "+
        s"TextQuery((title:transparency | title_stemmed:transparency)~$p (t:transparency | c:transparency | site_keywords:transparency | ts:transparency | cs:transparency)~$r ())"
      ...
      parser.parse("bose-einstein condensate").get.toString ===
        ...
        "()) "+
        "TextQuery("+
        s"""(title:condensate | title_stemmed:condensate)~$p (t:condensate | c:condensate | site_keywords:condensate | ts:condensate | cs:condensate)~$r """+
        "())"
      ...
      parser.parse("\"Spin-statistics\" theorem").get.toString ===
        ...
        "()) "+
        "TextQuery("+
        s"""(title:theorem | title_stemmed:theorem)~$p (t:theorem | c:theorem | site_keywords:theorem | ts:theorem | cs:theorem)~$r """ +
        "())"
    }
    ...
    "expand queries (with concat)" in new QueryParserScope(concatBoostValue = 0.5f) {
      parser.parse("super conductivity").get.toString ===
        ...
        s"(t:super | c:super | site_keywords:super | ts:super | cs:super |"+
        s" t:superconductivity^0.5 | c:superconductivity^0.5 | site_keywords:superconductivity^0.5 | ts:superconductivity^0.5 | cs:superconductivity^0.5)~$r "+
        "()) "+
        "TextQuery("+
        s"(title:conductivity | title_stemmed:conductivity |"+
        s" title:superconductivity^0.5 | title_stemmed:superconductivity^0.5)~$p " +
        s"(t:conductivity | c:conductivity | site_keywords:conductivity | ts:conductivity | cs:conductivity |"+
        s" t:superconductivity^0.5 | c:superconductivity^0.5 | site_keywords:superconductivity^0.5 | ts:superconductivity^0.5 | cs:superconductivity^0.5)~$r "+
        "())"
      ...
      parser.parse("Electromagnetically induced transparency").get.toString ===
        ...
        s"(t:electromagnetically | c:electromagnetically | site_keywords:electromagnetically | ts:electromagnet | cs:electromagnet |"+
        s" t:electromagneticallyinduced^0.5 | c:electromagneticallyinduced^0.5 | site_keywords:electromagneticallyinduced^0.5 |"+
        ...
        s"(t:induced | c:induced | site_keywords:induced | ts:induce | cs:induce |"+
        s" t:electromagneticallyinduced^0.5 | c:electromagneticallyinduced^0.5 | site_keywords:electromagneticallyinduced^0.5 | ts:electromagneticallyinduce^0.5 | cs:electromagneticallyinduce^0.5 |"+
        s" t:inducedtransparency^0.5 | c:inducedtransparency^0.5 | site_keywords:inducedtransparency^0.5 | ts:inducedtransparency^0.5 | cs:inducedtransparency^0.5)~$r "+
        "()) "+
        "TextQuery("+
        s"(title:transparency | title_stemmed:transparency | title:inducedtransparency^0.5 | title_stemmed:inducedtransparency^0.5)~$p "+
        s"(t:transparency | c:transparency | site_keywords:transparency | ts:transparency | cs:transparency |"+
        s" t:inducedtransparency^0.5 | c:inducedtransparency^0.5 | site_keywords:inducedtransparency^0.5 | ts:inducedtransparency^0.5 | cs:inducedtransparency^0.5)~$r "+
        "())"
      ...
      parser.parse("bose-einstein condensate").get.toString ===
        ...
        s""" t:boseeinstein^0.5 | c:boseeinstein^0.5 | site_keywords:boseeinstein^0.5 | ts:boseeinstein^0.5 | cs:boseeinstein^0.5 |"""+
        s""" t:boseeinsteincondensate^0.5 | c:boseeinsteincondensate^0.5 | site_keywords:boseeinsteincondensate^0.5 | ts:boseeinsteincondensate^0.5 | cs:boseeinsteincondensate^0.5)~$r """+
        "()) "+
        "TextQuery("+
        s"""(title:condensate | title_stemmed:condensate | title:boseeinsteincondensate^0.5 | title_stemmed:boseeinsteincondensate^0.5)~$p """+
        s"""(t:condensate | c:condensate | site_keywords:condensate | ts:condensate | cs:condensate |"""+
        s""" t:boseeinsteincondensate^0.5 | c:boseeinsteincondensate^0.5 | site_keywords:boseeinsteincondensate^0.5 | ts:boseeinsteincondensate^0.5 | cs:boseeinsteincondensate^0.5)~$r """+
        "())"
      ...
      parser.parse("\"Spin-statistics\" theorem").get.toString ===
        ...
        s"""(t:theorem | c:theorem | site_keywords:theorem | ts:theorem | cs:theorem)~$r """+
        "())"
    }
  }
}

...
class ScoreContextTest extends Specification {
  ...
  "compute visibilities" in {
    val visibilities = rnd.shuffle(Seq[Int](Visibility.RESTRICTED, Visibility.OTHERS, Visibility.NETWORK, Visibility.FOLLOWER, Visibility.OWNER, Visibility.HAS_SECONDARY_ID))

...
class UriWeightingHelperTest extends Specification with CuratorTestInjector {
  ...
  private def makeSeedItems(): Seq[SeedItem] = {
    ...
    val seedItem16 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](16),
      ...
      seq = SequenceNumber[SeedItem](16), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    //dropbox
    val seedItem17 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](17),
      url = "https://www.dropbox.com/links",
      seq = SequenceNumber[SeedItem](17), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    //craigslist
    val seedItem18 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](18),
      ...
      seq = SequenceNumber[SeedItem](18), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    //support page
    val seedItem19 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](19),
      url = "https://developers.facebook.com/support/",
      seq = SequenceNumber[SeedItem](19), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    ...
    val seedItem20 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](20),
      ...
      seq = SequenceNumber[SeedItem](20), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    ...
    val seedItem21 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](21),
      ...
      seq = SequenceNumber[SeedItem](21), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    ...
    val seedItem22 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](22),
      ...
      seq = SequenceNumber[SeedItem](22), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    ...
    val seedItem23 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](23),
      ...
      seq = SequenceNumber[SeedItem](23), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    ...
    val seedItem24 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](24),
      ...
      seq = SequenceNumber[SeedItem](24), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)

    //tripadvisor
    val seedItem25 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](25),
      url = "http://www.tripadvisor.com/TravelersChoice",
      seq = SequenceNumber[SeedItem](25), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    ...
    val seedItem26 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](26),
      ...
      seq = SequenceNumber[SeedItem](26), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)
    ...
    val seedItem27 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](27),
      ...
      seq = SequenceNumber[SeedItem](27), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)

    //Videos on Youtube
    val seedItem28 = SeedItem(userId = Id[User](42), uriId = Id[NormalizedURI](28),
      url = "https://www.youtube.com/watch?v=NedZT-tIBLA",
      seq = SequenceNumber[SeedItem](28), priorScore = None, timesKept = 20, lastSeen = currentDateTime, keepers = Keepers.ReasonableNumber(Seq(Id[User](1), Id[User](2))), discoverable = true)

...
object FixedSetURIReco {
  private def fakeMasterScore: Float = 18f // empirically the upper bound. becomes invalid if scoring method changes
  ...
  val entre = List(1130168, 4202342, 3822739, 4202423, 3165175, 1431596, 1968521, 2876852, 2055027, 1968517, 4076277, 1968520, 4241599, 1108681, 1968522, 4102803, 3889507, 3784915, 3515752, 2959918, 3143556, 3143359, 665227, 3132970, 3031172)
  ...
  val investor = Seq(3461742, 2959015, 4198017, 4198028, 2896932, 4235828, 1464147, 3940501, 1371687, 3713352, 345799)
  ...
  val gamer = Seq(4210195, 4261443, 1846078, 4276165, 3607580, 4213139, 4377442, 1991358, 1797240, 1791050, 1723651, 1646075, 1796254, 1582084, 1562583, 3072725)

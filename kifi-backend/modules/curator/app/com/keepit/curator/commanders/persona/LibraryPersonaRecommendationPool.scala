...
object FixedSetLibraryReco {
  ...
  private def fakeMasterScore = 6f // empirically the upper bound. becomes invalid if scoring method changes
  ...
  val techie = Seq(47284, 48709, 27570, 25000, 26464, 46406, 27871, 62291)
  val entre = Seq(27657, 27238, 24202, 28517, 25243, 25080, 25168, 25168, 46821, 27559, 49025, 28596, 28004)
  val art = Seq(24542, 49090, 28598, 30661, 41439, 48796, 50874, 50818, 27676, 24932, 45019, 26758, 46742)
  val foodie = Seq(49135, 26342, 46919, 47979, 50833, 31609, 28439, 25258, 45250, 46833, 26460, 47915, 57428)
  ...
  val health = Seq(47889, 47915, 47191, 49088, 41145, 30684, 28738, 31354, 44656, 25356, 1050829)
  ...
  val animal = Seq(49078, 49020, 27548, 49009, 28762, 24103, 43649, 28125, 60945)

...
class LibraryFixedSetPersonaRecoPool @Inject() () extends FixedSetPersonaRecoPool[Library, LibraryRecommendation] with LibraryPersonaRecommendationPool {
  ...
  val specialBoostSet = Set(46862, 36680, 49078, 24103, 47498, 51798, 47889, 47191, 47494, 48661, 49090, 50874, 49135, 26460, 27238, 25168, 50812, 47488, 42651, 27760, 25368, 44475, 24203, 50862, 47284, 25000, 27545, 51496, 27049, 26465, 542271).map { Id[Library](_) }
...
object FixedSetLibraryReco {
  ...
  val techie = Seq(47284, 48709, 27570, 25000, 26464, 46406, 27871, 62291, 26151, 71994, 76239, 31600, 542271)
  val entre = Seq(27657, 27238, 24202, 28517, 25243, 25080, 25168, 46821, 27559, 49025, 28596, 28004, 71994, 44610, 273656, 542271)
  ...
  val investor = Seq(27569, 24203, 27559, 40373, 50862, 26443, 56032, 26438, 25371, 542271)

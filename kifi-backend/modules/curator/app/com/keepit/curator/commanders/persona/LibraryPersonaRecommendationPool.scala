...
object FixedSetLibraryReco {
  ...
  val techie = Seq(47284, 48709, 27570, 25000, 26464, 46406, 27871, 62291, 26151)
  ...
  val parent = Seq(279185, 46862, 46860, 46861, 47438, 36680, 50551, 25345, 32127, 46824, 45472, 279184)

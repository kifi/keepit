...
insert into evolutions (name, description) values('150.sql', 'add columns invited_by and invitation_sent to rich_social_connection and drop columns invitation and invitation_count');

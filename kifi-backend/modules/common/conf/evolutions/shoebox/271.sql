...
CREATE TABLE library_image (
  ...
  crop_center_x tinyint(3) unsigned DEFAULT NULL,
  crop_center_y tinyint(3)  unsigned DEFAULT NULL,
  crop_width tinyint(3) unsigned DEFAULT NULL,
  crop_height tinyint(3) unsigned DEFAULT NULL,

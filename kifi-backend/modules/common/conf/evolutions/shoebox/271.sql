...
CREATE TABLE library_image (
  ...
  selectedWidth smallint(6) unsigned NOT NULL,
  selectedHeight smallint(6) unsigned NOT NULL,
  offsetWidth smallint(6) unsigned NOT NULL,
  offsetHeight smallint(6)  unsigned NOT NULL,

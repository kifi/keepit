...
CREATE TABLE library_image (
  ...
  originalWidth smallint(5) unsigned NOT NULL,
  originalHeight smallint(5) unsigned NOT NULL,
  selectedWidth smallint(5) unsigned NOT NULL,
  selectedHeight smallint(5) unsigned NOT NULL,
  offsetWidth smallint(5) unsigned NOT NULL,
  offsetHeight smallint(5) unsigned NOT NULL,

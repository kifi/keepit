...
CREATE TABLE url_pattern_rule (
    ...
    UNIQUE INDEX url_pattern (pattern)

);

insert into evolutions (name, description) values('97.sql', 'delete normalization_scheme from domain and create table url_pattern_rule');

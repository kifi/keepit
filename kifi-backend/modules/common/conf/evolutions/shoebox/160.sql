...
-- MySQL:
-- ALTER TABLE keep_click DROP FOREIGN KEY keep_click_clicker_id
ALTER TABLE keep_click DROP CONSTRAINT keep_click_clicker_id;
ALTER TABLE keep_click DROP COLUMN clicker_id;

-- MySQL:
-- ALTER TABLE keep_click DROP INDEX keep_click_uuid;
ALTER TABLE keep_click DROP CONSTRAINT IF EXISTS keep_click_uuid;

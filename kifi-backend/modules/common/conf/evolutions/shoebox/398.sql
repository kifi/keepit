...
VALUES
  ...
  '["force_edit_libraries","invite_members","group_messaging","edit_organization","view_organization","remove_libraries","create_slack_integration","export_keeps","publish_libraries","view_members", "view_settings", "join_by_verifying"]',
  ...
  "remove_libraries":"members","invite_members":"members","view_organization":"anyone", "view_settings":"members", "join_by_verifying":"nonmembers"}'
  );

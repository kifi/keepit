...
object SlackFail {
  ...
  case object SlackTeamNotFound extends SlackFail(NOT_FOUND, "slack_team_not_found")
  case object SlackUserNotFound extends SlackFail(NOT_FOUND, "slack_user_not_found")

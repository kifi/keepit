...
trait ShoeboxServiceClient extends ServiceClient {
  ...
  def getPermissionsByOrgId(orgIds: Set[Id[Organization]], userId: Id[User]): Future[Map[Id[Organization], Set[OrganizationPermission]]]
}
...
class ShoeboxServiceClientImpl @Inject() (
  ...
  def getPermissionsByOrgId(orgIds: Set[Id[Organization]], userId: Id[User]): Future[Map[Id[Organization], Set[OrganizationPermission]]] = {
    ...
    call(Shoebox.internal.getPermissionsByOrgId, payload).map { _.json.as[Map[Id[Organization], Set[OrganizationPermission]]] }
  }
}

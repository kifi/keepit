...
case class RelatedEntities[E, R](id: Id[E], related: Seq[(Id[R], Double)], normalizingConstant: Double)
...
object RelatedEntities {
  ...
  implicit def format[E, R] = (
    ...
    (__ \ 'normalizingConstant).format[Double]
...
object SociallyRelatedEntitiesForUser {
  ...
  implicit def format: Format[SociallyRelatedEntitiesForUser] = (
    ...
    (__ \ 'normalizingConstant).format[Double] and

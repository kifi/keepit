...
object Shoebox extends Service {
  object internal {
    ...
    def getScrapedFullURIs(seqNum: SequenceNumber[NormalizedURI], fetchSize: Int) = ServiceRoute(GET, "/internal/shoebox/database/getScrapedFullURIs", Param("seqNum", seqNum), Param("fetchSize", fetchSize))
    ...
    def updateScreenshotsForUriId(id: Id[NormalizedURI]) = ServiceRoute(GET, "/internal/shoebox/screenshots/updateForId", Param("id", id))
    def getURIImage() = ServiceRoute(POST, "/internal/shoebox/image/getURIImage")
    def getUriImageForUriId(id: Id[NormalizedURI]) = ServiceRoute(GET, "/internal/shoebox/image/getUriImageForId", Param("id", id))

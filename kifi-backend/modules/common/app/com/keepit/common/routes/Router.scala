...
object Search extends Service {
  object internal {
    ...
    def correctSpelling(input: String) = ServiceRoute(GET, "/internal/search/spell/suggest", Param("input", input))
...
object ABook extends Service {
  object internal {
    ...
    def getABookInfo(id:Id[ABookInfo]) = ServiceRoute(GET, s"/internal/abook/getABookInfo", Param("id", id))

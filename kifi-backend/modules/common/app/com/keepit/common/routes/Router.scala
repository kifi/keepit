...
object Shoebox extends Service {
  object internal {
    ...
    def getLibraries() = ServiceRoute(POST, "/internal/shoebox/database/getLibraries")
    def getUserImages() = ServiceRoute(POST, "/internal/shoebox/database/getUserImages")
    def getKeeps() = ServiceRoute(POST, "/internal/shoebox/database/getKeeps")
    def getLibraryUrls() = ServiceRoute(POST, "/internal/shoebox/database/getLibraryUrls")
    def getLibraryInfos() = ServiceRoute(POST, "/internal/shoebox/database/getLibraryInfos")
    def getLibraryOwners() = ServiceRoute(POST, "/internal/shoebox/database/getLibraryOwners")
    def getOrganizations() = ServiceRoute(POST, "/internal/shoebox/database/getOrganizations")

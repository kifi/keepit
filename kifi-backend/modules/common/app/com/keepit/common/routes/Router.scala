...
object Shoebox extends Service {
  object internal {
    ...
    def getLibraryMembershipChanged(seqNum: SequenceNumber[LibraryMembership], fetchSize: Int) = ServiceRoute(GET, "/internal/shoebox/database/getLibraryMembershipChanged", Param("seqNum", seqNum), Param("fetchSize", fetchSize))
...
object Search extends Service {
  object internal {
    ...
    def distLangDetect() = ServiceRoute(POST, "/internal/search/dist/langDetect")

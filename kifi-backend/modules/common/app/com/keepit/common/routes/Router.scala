...
object Shoebox extends Service {
  object internal {
    ...
    def getVerifiedAddressOwner() = ServiceRoute(POST, "/internal/shoebox/database/getVerifiedAddressOwner")
  }
}
...
object Scraper extends Service {
  object internal {
    ...
    def detectPorn() = ServiceRoute(POST, s"/internal/scraper/detectPorn")
  }
}

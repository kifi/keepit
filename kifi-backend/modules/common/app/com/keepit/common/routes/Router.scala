...
object Search extends Service {
  object internal {
    ...
    def explain(query: String, userId: Id[User], uriId: Id[NormalizedURI], lang: Option[String], debug: Option[String]) =
      ServiceRoute(GET, "/internal/search/search/explainResult", Param("query", query), Param("userId", userId), Param("uriId", uriId), Param("lang", lang), Param("debug", debug))
...
object Cortex extends Service {
  ...
  object internal {
    ...
    def ldaNumOfTopics(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/numOfTopics", Param("version", version))
    def ldaShowTopics(fromId: Int, toId: Int, topN: Int)(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/showTopics", Param("fromId", fromId), Param("toId", toId), Param("topN", topN), Param("version", version))
    def ldaWordTopic(word: String)(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/wordTopic", Param("word", word), Param("version", version))
    def ldaDocTopic(implicit version: LDAVersionOpt = None) = ServiceRoute(POST, "/internal/cortex/lda/docTopic", Param("version", version))
    def ldaConfigurations(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/confs", Param("version", version))
    def saveEdits(implicit version: LDAVersionOpt = None) = ServiceRoute(POST, "/internal/cortex/lda/saveEdits", Param("version", version))
    def userUriInterest(userId: Id[User], uriId: Id[NormalizedURI])(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/userUriInterest", Param("userId", userId), Param("uriId", uriId), Param("version", version))
    def batchUserURIsInterests(implicit version: LDAVersionOpt = None) = ServiceRoute(POST, "/internal/cortex/lda/batchUserUrisInterests", Param("version", version))
    def userTopicMean(userId: Id[User])(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/userTopicMean", Param("userId", userId), Param("version", version))
    def sampleURIsForTopic(topicId: Int)(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/sampleURIs", Param("topicId", topicId), Param("version", version))
    def getSimilarUsers(userId: Id[User], topK: Int)(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/getSimilarUsers", Param("userId", userId), Param("topK", topK), Param("version", version))
    def unamedTopics(limit: Int)(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/unamedTopics", Param("limit", limit), Param("version", version))
    def getTopicNames(implicit version: LDAVersionOpt = None) = ServiceRoute(POST, "/internal/cortex/lda/getTopicNames", Param("version", version))
    def explainFeed(implicit version: LDAVersionOpt = None) = ServiceRoute(POST, "/internal/cortex/lda/explainFeed", Param("version", version))
    def libraryTopic(libId: Id[Library])(implicit version: LDAVersionOpt = None) = ServiceRoute(GET, "/internal/cortex/lda/libraryTopic", Param("libId", libId), Param("version", version))

...
object ABook extends Service {
  object internal {
    ...
    def getContactsByUser(userId: Id[User], page: Option[Int], pageSize: Option[Int]) = ServiceRoute(GET, s"/internal/abook/${userId}/getContacts", Param("page", page), Param("pageSize", pageSize))
  }
}

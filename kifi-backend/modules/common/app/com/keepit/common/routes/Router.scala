...
object Shoebox extends Service {
  object internal {
    ...
    def getLibrariesAndMembershipIdsChanged(seqNum: SequenceNumber[Library], fetchSize: Int) = ServiceRoute(GET, "/internal/shoebox/database/getLibrariesAndMembershipIdsChanged", Param("seqNum", seqNum), Param("fetchSize", fetchSize))

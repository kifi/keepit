...
object EmailAddresses {
  ...
  case object JOON extends SystemEmailAddress("joon@42go.com")
  ...
  val NON_ENG_EMAILS = Seq(TEAM, INVITATION, SUPPORT, OLD_SUPPORT, NOTIFICATIONS, ENG, CONGRATS, EDUARDO, EFFI, NOTIFY)

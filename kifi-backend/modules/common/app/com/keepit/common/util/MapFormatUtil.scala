...
object MapFormatUtil {
  ...
  implicit def uriRecommendationFeedbackMapFormat(implicit f: Format[Map[String, Boolean]]): Format[Map[UriRecommendationFeedback.Value, Boolean]] =
    mapKeyFormat(UriRecommendationFeedback.withName _, _.toString)

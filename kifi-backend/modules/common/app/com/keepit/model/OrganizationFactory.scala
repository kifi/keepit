...
object OrganizationFactory {
  ...
  case class PartialOrganization private[OrganizationFactory] (
    ...
    def withWeakMembers() = this // TODO(ryan): [NOW] make this mess with org settings to actually remove invite permissions
    def secret() = this // TODO(ryan): [NOW] make this mess with org settings to actually remove view permissions
  }
}

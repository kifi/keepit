...
object OrganizationFactory {
  ...
  case class PartialOrganization private[OrganizationFactory] (
      ...
      nonstandardSettings: Set[FeatureSettingPair[_ <: Feature]] = Set.empty) {
    ...
    def secret() = this.copy(nonstandardSettings = nonstandardSettings + FeatureSettingPair(Feature.ViewOrganization, Feature.ViewOrganization.MEMBERS))
  }
}

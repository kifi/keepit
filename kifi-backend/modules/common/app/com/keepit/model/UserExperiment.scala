...
object ExperimentType {
  ...
  val SEARCH_LAB = ExperimentType("search_lab")
  ...
  val _ALL = ADMIN :: AUTO_GEN :: FAKE :: BYPASS_ABUSE_CHECKS :: VISITED :: NO_SEARCH_EXPERIMENTS ::
    ...
    RECO_FASTLANE :: RECO_SUBSAMPLE :: APPLY_RECO_FEEDBACK :: PLAIN_EMAIL :: GRATIFICATION_EMAIL :: ORGANIZATION :: SUBSCRIPTION :: SEARCH_LAB :: Nil

...
object ExperimentType {
  ...
  val CURATOR_NONLINEAR_SCORING = ExperimentType("curator_nonlinear_scoring")
  ...
  val _ALL = ADMIN :: AUTO_GEN :: FAKE :: VISITED :: NO_SEARCH_EXPERIMENTS ::
    ...
    CURATOR_LIBRARY_RECOS :: CURATOR_NONLINEAR_SCORING :: NEW_PUBLIC_FEED :: PROFILES_BETA :: TWITTER_BETA :: Nil

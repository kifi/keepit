...
object ExperimentType {
  ...
  val SEARCH_SUGGESTIONS = ExperimentType("search_suggestions")
  ...
  val _ALL = ADMIN :: AUTO_GEN :: FAKE :: BYPASS_ABUSE_CHECKS :: VISITED :: NO_SEARCH_EXPERIMENTS ::
    ...
    NEW_PUBLIC_FEED :: SEARCH_SUGGESTIONS :: PROFILES_BETA :: TWITTER_BETA :: ACTIVITY_EMAIL :: ALL_KEEPS_VIEW :: EXPLICIT_SOCIAL_POSTING :: Nil

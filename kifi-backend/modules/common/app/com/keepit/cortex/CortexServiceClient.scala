...
trait CortexServiceClient extends ServiceClient {
  ...
  def batchUserURIsInterests(userId: Id[User], uriIds: Seq[Id[NormalizedURI]])(implicit version: LDAVersionOpt): Future[Seq[LDAUserURIInterestScores]]
  ...
  def getTopicNames(uris: Seq[Id[NormalizedURI]])(implicit version: LDAVersionOpt): Future[Seq[Option[String]]]
  def explainFeed(userId: Id[User], uriIds: Seq[Id[NormalizedURI]])(implicit version: LDAVersionOpt): Future[Seq[Seq[Id[Keep]]]]

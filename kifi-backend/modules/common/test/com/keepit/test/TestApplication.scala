...
class TestApplication(path: File = new File("."))(overridingModules: Module*)
  extends TestApplicationFromGlobal(path, new TestGlobal(Seq(FakeClockModule(), FakeHealthcheckModule()), overridingModules))

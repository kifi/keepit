...
class ShoeboxServiceClientTest extends Specification with CommonTestInjector {
  ...
  val user1965 = User(firstName = "Richard", lastName = "Feynman", username = Username("dickyfey"), normalizedUsername = "dickyfey", pictureName = Some("0")).withId(Id[User](1965))
  val user1933 = User(firstName = "Paul", lastName = "Dirac", username = Username("cyberpaul1992"), normalizedUsername = "cyberpaul1992", pictureName = Some("0")).withId(Id[User](1933))

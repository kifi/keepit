...
class BasicUserTest extends Specification {
  ...
  "BasicUser formats" should {
    val basicUser1 = BasicUser(externalId = ExternalId[User]("58328718-0222-47bf-9b12-d2d781cb8b0c"), firstName = "Chris", lastName = "Christie", pictureName = "1.jpg", username = Some(Username("cc")))
    val basicUser2 = BasicUser(externalId = ExternalId[User]("9813c3a2-f283-4056-ac9f-04d2e39d15a2"), firstName = "Janet", lastName = "Jackson", pictureName = "2.jpg", username = Some(Username("jj")))

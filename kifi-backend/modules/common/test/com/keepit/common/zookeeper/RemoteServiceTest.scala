...
class RemoteServiceTest extends Specification {
  ...
  "RemoteService" should {
    ...
    "be deserialized and serialized" in {
      val json = Json.parse("""{"amazonInstanceInfo":{"instanceId":{"id":"i-ea0e8ab7"},"localHostname":"ip-10-166-30-185.us-west-1.compute.internal","publicHostname":"ec2-50-18-71-24.us-west-1.compute.amazonaws.com","localIp":{"ip":"10.166.30.185"},"publicIp":{"ip":"50.18.71.24"},"instanceType":"c1.xlarge","availabilityZone":"us-west-1b","securityGroups":"default","amiId":"ami-a82315ed","amiLaunchIndex":"0"},"status":"up","serviceType":"SEARCH"}""")

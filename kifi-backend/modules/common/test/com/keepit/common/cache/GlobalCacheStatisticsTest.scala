...
class GlobalCacheStatisticsTest extends Specification {
  ...
  "GlobalCacheStatistics" should {
    "record miss ratios has nothing" in {
      ...
      stats.missRatios(minSample = 5, minRatio = 20).head === ("aaa", 39)
      ...
      stats.missRatios(minSample = 2, minRatio = 35) === Seq(("aaa", 39))
      ...
      stats.missRatios(minSample = 2, minRatio = 35) === Seq(("aaa", 39), ("ccc", 75))
      ...
      stats.missRatios(minSample = 1, minRatio = 1).sortBy(_._1) === Seq(("aaa", 39), ("ccc", 75), ("bbb", 30)).sortBy(_._1)
    }
  }

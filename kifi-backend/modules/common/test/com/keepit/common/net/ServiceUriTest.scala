...
class ServiceUriTest extends Specification {
  "ServiceUri" should {
    "have a good summery" in {
      ...
      val uri = new ServiceUri(instance, null, -1, "/this/is/the/path/and/it/may/be/very/very/long/so/it/must/be/chopped/a/bit/if/you/know/what/i/mean")
      uri.summary === "TM1:/this/is/the/path/and/it/may/be/very/very/long/..."
    }
  }
}

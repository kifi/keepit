...
var Tempo = function(k) {
  ...
  p.prototype = {when:function(a, b) {
    ...
    a = null;
    return f.startsWith(b, "_tempo.") ? eval("t." + b.substring(7, b.length)) : a = "." === b ? eval("i") : "this" === b || null !== b.match(/this[\\[\\.]/) ? eval("i" + b.substring(4, b.length)) : "array" === f.typeOf(c) ? eval("i" + b) : eval("i." + b)
    ...
    d = d.replace(RegExp(b, "gi"), function(a) {
      return"i." + a
    });

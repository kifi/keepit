  ...
  "ABook Commander" should {
    ...
    "handle imports from IOS and gmail and interning of Kifi contacts independently" in {
      withDb(modules: _*) { implicit injector =>
        ...
        val Seq(e3Res) = commander.internKifiContacts(u42, Seq(e3))

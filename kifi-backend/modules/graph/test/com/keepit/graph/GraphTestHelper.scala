...
trait GraphTestHelper {
  ...
  val keepGraphUpdate1 = KeepGraphUpdate(Keep(id = Some(keepid1), uriId = uriid1, urlId = urlid1, url = "url1", userId = u43, source = KeepSource("site"), seq = SequenceNumber(3), libraryId = Some(Id[Library](1))))
  val keepGraphUpdate2 = KeepGraphUpdate(Keep(id = Some(keepid2), uriId = uriid2, urlId = urlid2, url = "url2", userId = u43, source = KeepSource("site"), seq = SequenceNumber(4), libraryId = Some(Id[Library](1))))
  val keepGraphUpdate3 = KeepGraphUpdate(Keep(id = Some(keepid3), uriId = uriid3, urlId = urlid3, url = "url3", userId = u43, source = KeepSource("site"), seq = SequenceNumber(5), libraryId = Some(Id[Library](1))))
  val keepGraphUpdate4 = KeepGraphUpdate(Keep(id = Some(keepid4), uriId = uriid4, urlId = urlid4, url = "url4", userId = u43, source = KeepSource("site"), seq = SequenceNumber(6), libraryId = Some(Id[Library](1))))
  val keepGraphUpdate5 = KeepGraphUpdate(Keep(id = Some(keepid5), uriId = uriid5, urlId = urlid5, url = "url5", userId = u42, source = KeepSource("site"), seq = SequenceNumber(7), libraryId = Some(Id[Library](1))))

...
trait GraphTestHelper {
  ...
  val userUpdate = UserGraphUpdate(User(id = Some(u42), firstName = "Tan", lastName = "Lin", seq = SequenceNumber(1), username = Username("test"), normalizedUsername = "test", pictureName = Some("0")))

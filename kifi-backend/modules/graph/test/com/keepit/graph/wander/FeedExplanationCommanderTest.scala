...
trait FeedHelper {
  ...
  val userUpdate = UserGraphUpdate(User(id = Some(Id[User](1)), firstName = "Dummy", lastName = "Yummy", seq = SequenceNumber(1), username = Username("test"), normalizedUsername = "test", pictureName = Some("0")))

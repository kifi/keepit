...
commit ace3ee3fc7 + pull requests 521, 522, 523
...
(function(a) {
  ...
  a.TokenList = function(b, h, l) {
    ...
    function G() {
      v.css({position:"absolute", top:k.offset().top + k[0].getBoundingClientRect().height, left:k.offset().left, width:k.width(), "z-index":a(b).data("settings").zindex}).show()
    }
    function J(c, e) {
      if(e && e.length) {
        v.empty();
    ...
    }).insertBefore(j), u = a("<li />").addClass(a(b).data("settings").classes.inputToken).appendTo(k).append(g), v = a("<div>").addClass(a(b).data("settings").classes.dropdown).appendTo("html").hide(), P = a("<tester/>").insertAfter(g).css({position:"absolute", top:-9999, left:-9999, width:"auto", fontSize:g.css("fontSize"), fontFamily:g.css("fontFamily"), fontWeight:g.css("fontWeight"), letterSpacing:g.css("letterSpacing"), whiteSpace:"nowrap"});
    j.val("");

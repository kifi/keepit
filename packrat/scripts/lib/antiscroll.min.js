...
this.innerPaneMouseWheelListener);a=this.pane.options.initialDisplay;!1!==a&&(this.show(),this.pane.autoHide&&(this.hiding=setTimeout(b.proxy(this,"hide"),parseInt(a,10)||3E3)))}function k(a,e){function d(){}d.prototype=e.prototype;a.prototype=new d}function g(){if(void 0===h){var a=b('<div class="kifi-scroll-inner" style="width:50px;height:50px;overflow-y:scroll;position:absolute;top:-200px;left:-200px;"><div style="height:100px;width:100%"></div></div>');b("body").append(a);var e=b(a).innerWidth(),d=
b("div",a).innerWidth();b(a).remove();h=e-d}return h}b.fn.antiscroll=function(a){return this.each(function(){b(this).data("antiscroll")&&b(this).data("antiscroll").destroy();b(this).data("antiscroll",new b.Antiscroll(this,a))})};b.Antiscroll=f;f.prototype.refresh=function(){var a=this.inner.get(0).scrollWidth>this.el.width()+(this.y?g():0),e=this.inner.get(0).scrollHeight>this.el.height()+(this.x?g():0);this.x&&(!this.horizontal&&a?this.horizontal=new c.Horizontal(this):this.horizontal&&!a?(this.horizontal.destroy(),

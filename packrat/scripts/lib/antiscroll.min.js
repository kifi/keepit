...
this.innerPaneMouseWheelListener);a=this.pane.options.initialDisplay;!1!==a&&(this.show(),this.pane.autoHide&&(this.hiding=setTimeout(c.proxy(this,"hide"),parseInt(a,10)||3E3)))}function l(a,e){function d(){}d.prototype=e.prototype;a.prototype=new d}function h(){if(void 0===k){var a=c('<div class="kifi-scroll-inner" style="width:50px;height:50px;overflow-y:scroll;position:absolute;top:-200px;left:-200px;"><div style="height:100px;width:100%"></div>');c("body").append(a);var e=c(a).innerWidth(),d=c("div",

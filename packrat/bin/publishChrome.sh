...
read -p "Auth with dev@42go.com, then paste the code here: " CODE
...
if [[ -f $KIFI_CHROME_EXTENSION_PATH ]]; then
  ...
  echo "Successfully published. Check it out at https://chrome.google.com/webstore/developer/dashboard"
